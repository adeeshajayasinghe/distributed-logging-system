...
func main() {
	...
	cmd := &cobra.Command{
		...
		// Runs main logic of the command
		RunE:    cli.run,
	}
...
// Data that common to all commands
type cli struct {
	cfg cfg
}
...
// User to configure the agent and learn default configuration
// This calls before running the RunE function
func setupFlags(cmd *cobra.Command) error {
	...
	dataDir := path.Join(os.TempDir(), "dls")
...
// Read the configuration and prepares agent configuration
